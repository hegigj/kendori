...
import {DependencyInjectionContainer} from "../../lib/models/dependency-injection.container";
...
@Component({
    ...
    template: `
        <h1>Ckemi {{title}}</h1>
        <p>Add new task</p>
        <form onsubmit="DependencyInjectionContainer.getDependency(AppComponent)?.addTask(event)">
